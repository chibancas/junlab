...
export default function Home() {
  return (
    <main className="grid grid-cols-2 content-start justify-center place-items-center gap-2 py-4">
      <h1 className= "col-span-2 text-center text-5xl">
        Welcome to my Site!
      </h1>
      ...
      <figure className="col-span-1 flex flex-col justify-center items-center gap-2">
        <Image src={"/yo.jpg"} alt={"A picture of me taken randomly."} width={100} height={100} className="rounded-full" />
